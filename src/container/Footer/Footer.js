    ...
    return (
        <div className="footer-section section footer-bg-color">
            <div className="container">
                        ...
                        <div className="footer-widget">
                            ...
                            <div className="footer-widget-content">
                                <div className="content">
                                    <p><Link to={process.env.PUBLIC_URL + "/"}>(+1) 678-435-6280</Link></p>
                                    <p><Link to={process.env.PUBLIC_URL + "/"}>bptechcomp@gmail.com</Link> </p>
                                </div>
                ...
                <div className="row">
                    <div className="col">
                        <p className="copyright">Copyright &copy; 2022 <strong>BP Tech Company.</strong> All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
